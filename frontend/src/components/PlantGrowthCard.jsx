  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-card flex flex-col justify-between h-full">
      <div className="flex items-center justify-between mb-2">
        <h3 className="text-xs font-semibold text-gray-500 dark:text-gray-400">Plant growth activity</h3>
        <button className="flex items-center gap-1.5 text-xs font-semibold text-gray-600 dark:text-gray-300 bg-gray-50 px-2.5 py-1 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-100" type="button">
          Weekly
      ...
      <div className="relative w-full h-36 mt-2">
        ...
        <div className="absolute inset-0 flex justify-between pointer-events-none px-6">
          <div className="border-r border-gray-100 dark:border-gray-700 h-full"></div>
          <div className="border-r border-gray-100 dark:border-gray-700 h-full"></div>
        </div>
        ...
        <div className="absolute left-2 bottom-3 transform -translate-x-1/2">
          <div className="w-8 h-8 rounded-full bg-white dark:bg-gray-800 border-2 border-[#E5E7EB] shadow-sm flex items-center justify-center p-1">
        ...
        <div className="absolute left-1/2 top-4 transform -translate-x-1/2 flex flex-col items-center">
          ...
          <div className="w-8 h-8 rounded-full bg-white dark:bg-gray-800 border-2 border-brand-lime shadow-md flex items-center justify-center p-1">
      ...
      <div className="flex justify-between items-center text-[10px] font-bold text-gray-800 dark:text-gray-100 tracking-tight pt-3 border-t border-gray-100 dark:border-gray-700 mt-2">
